...
uikit__WEBPACK_IMPORTED_MODULE_0___default().util.on('#js-modal-confirm', 'click', function (e) {
  e.preventDefault();
  e.target.blur();
  uikit__WEBPACK_IMPORTED_MODULE_0___default().modal.confirm('UIkit confirm!').then(function () {
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./resources/js/confirmDelete.js");
