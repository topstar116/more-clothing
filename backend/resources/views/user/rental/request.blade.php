...
{{-- タイトル・メタディスクリプション --}}
@section('title', 'レンタル出品 STEP1 | モアクロ')
@section('description', 'レンタル出品 STEP1')
...
<section class="user__content">
    <div class="user__content__headline">
        <div class="user__content__headline__inner complete-message">
            ...
            <p>保管荷物から、レンタルに出品する<br>商品を選択してください。</p>
        </div>
    </div>
</section>
<section class="user__content">
        ...
        <div class="user__content__box__inner">
            <div class="user__content__box__list l-flex l-start">
                ...
                <div class="user__content__box__item">
                    <a href="{{ route('custody.rental.request.two', ['item_id' => $item->id, 'url' => $item->url]) }}">
                        <div class="item__img">
