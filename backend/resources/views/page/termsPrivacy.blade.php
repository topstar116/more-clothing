        ...
        <article class="uk-article">
            <div class="uk-child-width-expand@s" uk-grid>
                <ul class="uk-list uk-list-decimal">
                    <li>株式会社K-WEST（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</li>
                </ul>
            </div>
            <h2>第1条（個人情報）</h2>
            ...
            <p>
                住所：京都府向日市寺戸町向畑52番地5イーグルハウスビル3<br>
                社名：株式会社K－WEST<br>
                担当部署：モアクロ管理部<br>
                Eメールアドレス：info@more-clothing.site</p>
        </article>
    </div>
</section>
@endsection
