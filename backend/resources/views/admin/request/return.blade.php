...
{{--  タイトル・メタディスクリプション  --}}
@section('title', '返却リクエスト一覧 | モアクロ')
@section('description', '返却リクエスト一覧')
...
@section('content')
    ...
    <div id="modal-ok" uk-modal>
        <div class="uk-modal-dialog">
            ...
            <form method="POST" action="{{ route('admin.request.return.post') }}">
                @csrf
                ...
                <div class="uk-modal-body">
                    ...
                    <div class="user__content__box__gray">
                        <p class="sub-headline">返却郵送会社</p>
                        <input name="company" class="uk-input user__content__box__gray__inner">
                    </div>
                    <div class="user__content__box__gray">
                        <p class="sub-headline">返却追跡番号</p>
                        <input name="number" class="uk-input user__content__box__gray__inner">
                    </div>
                    <div class="user__content__box__gray">
                        <p class="sub-headline">返却予定日</p>
    ...
    <div id="modal-no" uk-modal>
        <div class="uk-modal-dialog">
            ...
            <form method="POST" action="{{ route('admin.request.return.reject') }}">
                @csrf
        ...
        <table class="uk-table uk-table-responsive uk-table-divider">
            <thead>
                <tr>
                    ...
                    <th style="white-space: nowrap">返却希望日時</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $itemRequest->request_return_at }}</td>
                ...
                {{--  <tr>
                    ...
                    <td>サンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプルサンプル</td>
                    <td style="white-space: nowrap">
