...
<!-- タイトル・メタディスクリプション -->
@section('title', 'レンタル出品リクエスト一覧 | モアクロ')
@section('description', 'レンタル出品リクエスト一覧')
...
@section('content')
    ...
    <div id="modal-ok" uk-modal>
        <div class="uk-modal-dialog">
            ...
            <form method="POST" action="{{ route('admin.request.rental.post') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="uk-modal-body">
                    ...
                    <div class="user__content__box__gray">
                        <p class="sub-headline">商品名</p>
                        <input name="name" class="uk-input user__content__box__gray__inner" required="required">
                    </div>
                    <div class="user__content__box__gray">
                        <p class="sub-headline">商品説明</p>
                        <textarea name="detail" class="uk-input user__content__box__gray__inner" required="required"></textarea>
                    </div>
                    <div class="user__content__box__gray">
                        <p class="sub-headline">表示画像</p>
        ...
        <table class="uk-table uk-table-responsive uk-table-divider">
            <thead>
                <tr>
                    ...
                    <th style="white-space: nowrap">対象荷物</th>
                    <th style="white-space: nowrap">レンタル希望価格</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $itemRequest->request_rental }}</td>
