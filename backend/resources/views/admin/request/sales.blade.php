...
<!-- タイトル・メタディスクリプション -->
@section('title', '販売代行リクエスト一覧 | モアクロ')
@section('description', '販売代行リクエスト一覧')
...
@section('content')
    ...
    <div id="modal-ok" uk-modal>
        <div class="uk-modal-dialog">
            ...
            <form method="POST" action="{{ route('admin.request.sales.post') }}">
                @csrf
                ...
                <div class="uk-modal-body">
                    ...
                    <div class="user__content__box__gray">
                        <p class="sub-headline">販売金額</p>
                        <input name="selling_price" class="uk-input user__content__box__gray__inner">
                    </div>
                    <div class="user__content__box__gray">
                        <p class="sub-headline">販売開始日</p>
                        <vue-datapicker-now-component></vue-datapicker-now-component>
                    </div>
                    <div class="user__content__box__gray">
                        <p class="sub-headline">販売URL</p>
                        <input name="url" class="uk-input user__content__box__gray__inner">
                    </div>
                    <div class="user__content__box__gray">
    ...
    <div id="modal-no" uk-modal>
        <div class="uk-modal-dialog">
            ...
            <div class="uk-modal-body">
                <form method="POST" action="{{ route('admin.request.sales.reject') }}">
                    @csrf
        ...
        <table class="uk-table uk-table-responsive uk-table-divider">
            <thead>
                <tr>
                    ...
                    {{-- <th style="white-space: nowrap">希望最低金額</th> --}}
            ...
            <tbody>
                ...
                <tr>
                    ...
                    {{-- <td>{{ $itemRequest->request_sell }}</td> --}}
