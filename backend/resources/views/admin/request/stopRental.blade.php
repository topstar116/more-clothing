...
<!-- タイトル・メタディスクリプション -->
@section('title', 'レンタル出品停止リクエスト一覧 | モアクロ')
@section('description', 'レンタル出品停止リクエスト一覧')
...
@section('content')
    ...
    <div id="modal-ok" uk-modal>
        <div class="uk-modal-dialog">
            ...
            <form method="POST" action="{{ route('admin.stop.request.rental.post') }}">
                @csrf
    ...
    <div id="modal-no" uk-modal>
        <div class="uk-modal-dialog">
            ...
            <form method="POST" action="{{ route('admin.stop.request.rental.reject') }}">
                @csrf
